...
public partial class BackupView : UserControl
{
    ...
    private async void CheckDiskSpace_Click(object sender, Avalonia.Interactivity.RoutedEventArgs e)
        => await _vm.CheckDiskSpaceCommand.ExecuteAsync(null);
    private async void RunBackup_Click(object sender, Avalonia.Interactivity.RoutedEventArgs e)
        => await _vm.RunBackupCommand.ExecuteAsync(null);
    private async void CheckPitr_Click(object sender, Avalonia.Interactivity.RoutedEventArgs e)
        => await _vm.CheckPitrCommand.ExecuteAsync(null);
    private async void FixReplication_Click(object sender, Avalonia.Interactivity.RoutedEventArgs e)
